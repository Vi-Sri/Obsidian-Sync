...
The simplest way to install Obsidian-Sync is using Pip.

.. code-block:: console

    $ pip install obsidian-sync

This will install ``obsidian-sync`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/Vi-Sri/Obsidian-Sync/issues>`_.
